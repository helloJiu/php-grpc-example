 ...
 * 获取列表请求参数
 *
 * Generated from protobuf message <code>pb.experiment.IndexRequest</code>
 */
class IndexRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *租户
     *
     * Generated from protobuf field <code>string tenant = 3 [(.pb.validator.field) = {</code>
     */
    protected $tenant = '';
    /**
     *用户ID
     *
     * Generated from protobuf field <code>string user_id = 4 [(.pb.validator.field) = {</code>
     */
    protected $user_id = '';
    /**
