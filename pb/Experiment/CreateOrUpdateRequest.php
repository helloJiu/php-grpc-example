 ...
 * 创建或更新实验请求参数
 *
 * Generated from protobuf message <code>pb.experiment.CreateOrUpdateRequest</code>
 */
class CreateOrUpdateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *标题
     *
     * Generated from protobuf field <code>string title = 5 [(.pb.validator.field) = {</code>
     */
    protected $title = '';
    /**
     *实验缩略图
